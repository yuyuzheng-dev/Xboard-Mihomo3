...
import 'package:fl_clash/run.dart';
...
/// 初始化XBoard配置模块和域名服务
Future<bool> _initializeXBoardServices() async {
  try {
    ...
    // 3. 获取SDK配置和域名服务配置
    final sdkConfig = await ConfigFileLoaderHelper.getSdk-Config();
    final domainConfig =
        await ConfigFileLoaderHelper.getDomainServiceConfig();
